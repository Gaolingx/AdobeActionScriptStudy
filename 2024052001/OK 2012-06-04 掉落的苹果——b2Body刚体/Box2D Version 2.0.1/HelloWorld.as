package{
	...
	public class HelloWorld extends Sprite{
		...
		public function HelloWorld(){
			...
			addEventListener(MouseEvent.CLICK, get_click);
			
			// Add event for main loop
			addEventListener(Event.ENTER_FRAME, Update, false, 0, true);
			
			/********************************************
			 * creat the environment for all the bodys
			 * */
			// Creat world AABB
			...
			/********************************************
			 * creat the world which the environment blongs to 
			 * */
		...
		public function get_click(e:MouseEvent):void{
			UpdateMouseWorld();
			trace("getBodyAtMouse: " +GetBodyAtMouse(true));
		}
